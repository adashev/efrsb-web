...
public class MessagePublishingTests extends TestBase {
  ...
  private String nameForSaleOrderPledgedProperty =
   ...
   @Test(groups = {"au", "pau", "sro_au"}, priority = 1)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 3)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul", "sro_au"}, priority = 4)
  ...
  @Test(groups = {"au", "sro_au"}, priority = 5)
  ...
  @Test(groups = {"au", "sro_au"}, priority = 6)
  ...
  @Test(groups = {"au", "pau"}, priority = 10)
  ...
  @Test(groups = {"au", "pau"}, priority = 11)
  ...
  @Test(groups = {"au", "pau"}, priority = 12)
  ...
  @Test(groups = {"au", "pau"}, priority = 13)
  ...
  @Test(groups = {"au", "pau"}, priority = 14)
  ...
  @Test(groups = {"au", "pau"}, priority = 15)
  ...
  @Test(groups = {"au", "pau"}, priority = 16)
  ...
  @Test(groups = {"au", "pau"}, priority = 17)
  ...
  @Test(groups = {"au", "pau"}, priority = 18)
  ...
  @Test(groups = {"au", "pau"}, priority = 19)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 20)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 21)
  ...
  @Test(groups = {"au", "pau"}, priority = 22)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 23)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 24)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 25)
  ...
  @Test(groups = {"au", "pau"}, priority = 26)
  ...
  @Test(groups = {"au", "pau"}, priority = 27)
  ...
  @Test(groups = {"au", "pau"}, priority = 28)
  ...
  @Test(groups = {"au", "pau"}, priority = 29)
  ...
  @Test(groups = {"au", "pau"}, priority = 30)
  ...
  @Test(groups = {"au", "pau"}, priority = 31)
  ...
  @Test(groups = {"au", "pau"}, priority = 32)
  ...
  @Test(groups = {"au", "pau"}, priority = 33)
  ...
  @Test(groups = {"au", "pau"}, priority = 34)
  ...
  @Test(groups = {"au", "pau"}, priority = 35)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 36)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 37)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 38)
  ...
  @Test(groups = {"au", "pau"}, priority = 39)
  ...
  @Test(groups = {"au", "pau", "otfl", "otul"}, priority = 40)
  ...
  @Test(groups = {"au", "pau"}, priority = 41)
  ...
  @Test(groups = {"au", "pau"}, priority = 42)
  ...
  @Test(groups = {"au", "pau"}, priority = 43)
  ...
  @Test(groups = {"au", "pau"}, priority = 44)
  ...
  @Test(groups = {"au", "pau"}, priority = 45)
  ...
  @Test(groups = {"au", "pau"}, priority = 47)
  ...
  @Test(groups = {"au", "pau"}, priority = 48)
  ...
  @Test(groups = {"au", "pau"}, priority = 49)
  ...
  @Test(groups = {"au", "pau"}, priority = 50)
  ...
  @Test(groups = {"au", "pau"}, priority = 51)
  ...
  @Test(groups = {"au", "pau"}, priority = 52)
  @Description("Опубликовать \"Сведения о порядке и месте ознакомления с проектом плана реструктуризации\"")
  ...
  @Test(groups = {"au", "pau"}, priority = 53)
  @Description("Опубликовать \"Сведения о порядке и месте ознакомления с отчетом о результатах исполнения плана реструктуризации\"")
  public void testViewExecRestructuringPlan() throws InterruptedException {
   app.getMessagesListPage().clickAddMessage();
   app.getHelperBase().selectDebtor();
   app.getHelperBase().selectCourtCase("message");
   app.getNewMessagePage().selectTypeMessage("Сведения о порядке и месте ознакомления с отчетом о результатах исполнения плана реструктуризации");
   app.getHelperBase().clickNextButton();
   app.getHelperBase().setAddressForCorrespondence();
   app.getCreateMessagePage().inputPlaceOfAcquaintanceWithReport();
   app.getCreateMessagePage().fillTextField();
   app.getCreateMessagePage().saveMessage();
   app.getSignMessagePage().signMessage();
   app.getSignMessagePage().payFromPersonalAccount();
  ...
  @Test(groups = {"au", "pau"}, priority = 54)
  @Description("Опубликовать \"Сообщение о наличии или об отсутствии признаков преднамеренного или фиктивного банкротства\"")
  public void testDeliberateBankruptcy() throws InterruptedException {
    app.getMessagesListPage().clickAddMessage();
    app.getHelperBase().selectDebtor();
    app.getHelperBase().selectCourtCase("message");
    app.getNewMessagePage().selectTypeMessage("Сообщение о наличии или об отсутствии признаков преднамеренного или фиктивного банкротства");
    app.getHelperBase().clickNextButton();
    app.getHelperBase().setAddressForCorrespondence();
    app.getCreateMessagePage().fillTextField();
    app.getCreateMessagePage().saveMessage();
  ...
  @Test(groups = {"au", "pau"}, priority = 55)
  ...
  @Test(groups = {"au", "pau"}, priority = 56)
